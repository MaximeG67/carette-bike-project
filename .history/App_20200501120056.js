...
function HomeFree() {
  return (
    <SideNavLogged.Navigator>
      <SideNavLogged.Screen name='HomeFree' component={Home} />
      <SideNavLogged.Screen name="Connexion" component={LoginScreen} />
  </SideNavLogged.Navigator>
  );
}
    ...
    <AuthContext.Provider value={authContext}>
      <NavigationContainer>
        <Drawer.Navigator initialRouteName="Home">
          ...
          <Drawer.Screen name="Connectez-vous" component={HomeFree} />
          ) : (
